...
export const defaultNetworkAddresses = {
  public: 'http://node1.saipanchain.io:8000',
  test: 'http://node1.saipanchain.io:8000',
  local: 'http://node1.saipanchain.io:8000',
}
...
class WrappedServer extends sdk.Server {
  constructor(networkType, networkAddress, storage) {
    if (networkType === networks.public) sdk.Network.use(new sdk.Network('SPN Network ; Jan. 2019'));
    else if (networkType === networks.test) sdk.Network.use(new sdk.Network('SPN Network ; Jan. 2019'));
